...
local function createBeam(beamObj,world,startx,starty,endx,endy)
	...
	local beam = create_beam("Assets/Beams/shield.png", 0, 600, my_callback, 20)
	beam:begin_update()
	...
	AttachParticles(world, "BlueBeam", world:ScreenToWorld(startx,starty))	
	AttachParticles(world, "BlueBeam", world:ScreenToWorld(endx,endy))	
end
