...
local quest = Quest {
   ...
   objectives = {
      [1]={
              OBJECTIVES.kill_monster {
                 ...
                 text            = "[Q0V2_1_0_MSG]";
                 action			= "[Q0V2_1_0_ACTN]";
                 log_text		= "[Q0V2_1_0_LOG]";
                 end_text        = "[Q0V2_1_0_ENDMSG]";
                 next_state      = 2;
              },
           };
      [2]={
              OBJECTIVES.go_to_location {
                 ...
                 action			= "[Q0V2_2_0_ACTN]";
                 log_text		= "[Q0V2_2_0_LOG]";
                 next_state      = 3;
              },
          };
   };
   ...
   end_actions = {
      [3]={
                 ACTIONS.unlock_quest {quest="Q0V3", show=false},
                 ...
                 ACTIONS.give_faction_status {faction="11", amount=-25, show=false},
          };
   };
