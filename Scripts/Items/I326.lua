-- I326
-- Ion Beam Cannon - Does 17 Ion Damage to your enemy + 1 for every 4 Red or Green that you have.

local function activate(item, world, player, obj,weapon,engine,cpu)
	local amt = 17 + math.floor((weapon)/4) + math.floor((cpu)/4)
...
local function should_ai_use_item(item, world, player)
	return 60 + player:GetAttribute("weapon") + player:GetAttribute("cpu")
end
