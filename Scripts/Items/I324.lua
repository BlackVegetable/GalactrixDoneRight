-- I324
-- Adv Ion Laser - Does 7 Ion Damage to your enemy + 1 for every 4 Red that you have.

local function activate(item, world, player, obj,weapon,engine,cpu)
	local amt = 7 + math.floor((weapon)/4) + math.floor(player:GetCombatStat("gunnery")/49)
