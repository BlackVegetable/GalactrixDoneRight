-- I323
-- Basic Ion Laser - Does 5 Ion Damage to your enemy + 1 for every 5 Red that you have.

local function activate(item, world, player, obj,weapon,engine,cpu)
	local amt = 5 + math.floor((weapon)/5) + math.floor(player:GetCombatStat("gunnery")/49)
